...
public class JsonScannerOfResponseVK implements JsonScannerOfResponse {
    ...
    public final String getJsonOfResponse(final String postId)
            throws IOException {
    ...
    public final Record parseJsonOfResponse(final String linkToResource)
            throws IOException, NullPointerException {

        byte[] jsonData = getJsonOfResponse(parseLink(linkToResource))
    ...
    public final Record parseJsonByUserType(final String linkToResource,
    ...
    public final Record parseJsonByGroupType(final String linkToResource,
